...
public class TransactionRepositoryImpl implements TransactionRepository{
    ...
    private  static final String SQL_FIND_ALL  ="SELECT TRANSACTION_ID,CATEGORY_ID, USER_ID,AMOUNT,NOTE," +
            "TRANSACTION_DATE FROM ET_TRANSACTION WHERE USER_ID = ? AND CATEGORY_ID = ?";
private static final String SQL_FIND_BY_ID = "SELECT TRANSACTION_ID,CATEGORY_ID, USER_ID,AMOUNT,NOTE," +
        "TRANSACTION_DATE FROM ET_TRANSACTION WHERE USER_ID = ? AND CATEGORY_ID = ? AND TRANSACTION_ID = ? ";
    private static final String SQL_CREATE = "INSERT INTO ET_TRANSACTION (TRANSACTION_ID,CATEGORY_ID,USER_ID,AMOUNT,NOTE," +
            "TRANSACTION_DATE) VALUES (NEXTVAL('ET_TRANSACTION_SEQ'), ?,?,?,?,?)";
    private static final String SQL_UPDATE ="UPDATE ET_TRANSACTION SET AMOUNT = ?, NOTE = ?, TRANSACTION_DATE = " +
